...
// import 시에 CDN에서도 js/jsx 확장자는 생략가능함!
...
// 1번째 #root1에 출력하기
// ReactDOM.render(컴포넌트 리턴코드,찍을요소)
// 컴포넌트 리턴코드는 어떻게 쓰나?
// -->  <컴포넌트명 />
...
function MakeImg(props){
    return (
            <img src={"./images/"+props.iname} alt="아연맨" />
    );
} // MakeImg ///////////////////////////////////////
...
function Favorite(똥) {
    return (
        <h2>
            네가 좋아하는 색은 {똥.color}이야 <br />
            그리고 좋아하는 음식은 {똥.food}야 <br />
            취미는 {똥.hobby}다 알겟냐
        </h2>
    );
} /// Favorite 컴포 /////////////////////
...
// 컴포넌트로 호출하면 개별적으로 속성을 구분할수 있다
// 출력 : #root3
ReactDOM.render(<Favorite color="빨간색" food="핏짜" hobby="꼐임" />, document.querySelector("#root3"));

// 함수 컴포넌트 에서는 표현식 안에서
// {props.호출시 사용한 속성명} 이형식으로 전달된 값을 읽음

// 컴포넌트 재사용하기
// #root4에 다른사람의 좋아하는 색 , 음식, 취미를 출력한다
ReactDOM.render(<Favorite color="간색" food="치킨" hobby="볼ㄹ링" />, document.querySelector("#root4"));

/* 

컴포넌트 내부에서 다른 컴포넌트를 호출할수 있다!
...
// 출력 : #root6 에 외부 JSX 파일 컴포넌트 출력하기 -> 어벤져스
