...
/******************************************* 
  ...
  기능 : 서브 타이틀 요소구성
*******************************************/
function SubTitle(props){ // tit - 서브타이틀 / menu - 서브메뉴

  // 서브메뉴 있을경우 li데이터 생성하기
  // 전달변수 data에 드러오는 값은 메뉴 배열임!
  ...
  // JS 에서는 배열.map().join('') 로 사용했음
  // -> 리엑트에서는 리엑트용 map()을 다시 구성하여 바로 html코드를 리턴함
  // join() 불필요!!!
