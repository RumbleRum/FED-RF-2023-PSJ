...
// ///////////////////////////////////////////////////////////
// [객체의 속성(키 값)을 배열로 변환하여 배열 매서드 이용하기]
// 객체형식 -> {키:값}
...
// 객체는 급이 높아서 forEach를 쓸수없다 - for in
// console.log(frObj.forEach(val=))
...
function showFruit(){
    ...
    // 배열 앞에 추가하기 매서드 : unshift() <-> shift() 의 반대
    else if(btxt == '앞배열추가요~!'){
        // 대상 : fruit 배열
        // 읽어올곳 : #sel 박스 -> 값은 value
