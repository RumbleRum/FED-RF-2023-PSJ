...
/*************************************************************** 
            ...
            -> window는 주로 생략함!
            -> 개발자모드 'application' 탭에서 확인가능(F12)
...
function localSFn() {
    ...
    if (btxt == "처음") {
        ...
        // 해당 url로 관리되는 로컬쓰는 모두 지움 - clear()
        localStorage.clear();
        // 로컬쓰 개별로 지우는방법 removeItem(키명)
    } //// else if :전체삭제 ///////////////////////////////////////
    else if(btxt == '보여줘'){
...
function sessionSFn() {
    ...
    if (btxt == "처음") {
        ...
        // 해당 url로 관리되는 세션쓰는 모두 지움 - clear()
        sessionStorage.clear();
        // 세션쓰 개별로 지우는방법 removeItem(키명)
    } //// else if :전체삭제 ///////////////////////////////////////
    else if(btxt == '보여줘'){
