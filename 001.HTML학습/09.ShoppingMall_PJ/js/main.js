...
/* 
    (참고:JS에서 이름짓는 일반규칙)
    1. 변수/함수 : 캐믈 캐이스(첫단어 소문자 뒷단어 대문자시작)
    2. 생성자함수 / 클래스 : 파스칼 케이스 (모든 첫글자 대문자)
...
function loadFn() {
    ...
    function goSlide(){
        ...
        clickSts-1;// 잠금!
        setTimeout(() => clickSts=0,TIME_SLIDE); // 잠금 해제! - 0.4초
        ...
        // 4. 슬라이드 순번과 일치하는 블릿에 클래스넣기
        // 대상 : .indic li -> indic변수
        // 맨앞 슬라이드 li 'data-seq' 값 읽어오기
        // isRight 값이 트루이면 오른쪽버튼이고 순번은 [1]
