...
export const CartList = memo(({ selData, flag }) => {
    ...
    // 리스트 삭제 함수 ////////////////
    const deleteItem = (e) => {
        // 삭제기능만 작동하기 하게 위해 부모의 useRef 값인 flag값을
        // false로 변경하면 상단의 조건업데이트 값이 작동하지 않는다!
        // 삭제기능만 작동한다
        flag.current = false;

        let confMsg = "진짜 지울꺼야? 씹새끼야?";
        // 지울지 여부를 사용자에게 물어본다
        // confirm() 대화창에 '확인' -> true, '취소' -> false 리턴함!
        // confirm 은 alert과 유사하게 window객체에 있음.
