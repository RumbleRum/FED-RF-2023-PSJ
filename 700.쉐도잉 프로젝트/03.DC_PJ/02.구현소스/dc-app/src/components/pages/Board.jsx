...
export function Board() {
    ...
    // 1. 데이터 변경관리 변수 : 리스트에 표시되는 실제 데이터셋
    const [currData, setCurrData] = useState(null);

    // 2. 게시판 모드 관리변수
    const [bdMode, setBdMode] = useState("L");
    // 모드 구분값 : CRUD (Create/Read/Update/Delete)
    // C - 글쓰기 / R - 글읽기 / U - 글 수정 / D - 글 삭제(U에포함)
    // 상태추가 : L -  글 목록
    // 전체 5가지 상태값 : CRUD+L
    ...
    */
    ...
    const pagingLink = () => {
        ...
        // 전체레코드 수 / 페이지 단위수 (나머지가 있으면 +1)
        // 전체레코드 수 : pgBlock 변수에 할당
        // 2. 나머지수
        ...
        // 리엑트에서는 jsx 문법 코드를 배열에 넣고
        // 출력하면 바로 코드로 변환된다
        let pgCode = [];
        // 리턴코드/////////////////
        // 만약 빈태그 묶음에 key를 심어야 할경우
        // 불가하므로 Fragment를 써준다
